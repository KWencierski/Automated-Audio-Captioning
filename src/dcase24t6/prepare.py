...
import logging
import os
from dcase24t6.datamodules.mixup import MixupClotho
from dcase24t6.datamodules.caption_embeddings import CaptionEmbeddings
...
def prepare_data_metrics_models(
    ...
    # dataset_name = "gpt-mixup"
    # dataset = MixupClotho()

    # hdf_fname = "gpt_mixup.hdf"
    # hdf_fpath = dataroot.joinpath("HDF", hdf_fname)
    # os.makedirs(hdf_fpath.parent, exist_ok=True)
    ...
    #         pre_process,
    #         item,
    #         fmt_kwargs=dict(dataset=dataset_name, subset=''),
    #     )
    ...
    dataset_name = "caption_embeddings"
    dataset = CaptionEmbeddings()

    hdf_fname = "caption_embeddings.hdf"
    hdf_fpath = dataroot.joinpath("HDF", hdf_fname)
    os.makedirs(hdf_fpath.parent, exist_ok=True)
